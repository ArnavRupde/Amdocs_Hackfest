...
filefire = open('fire.txt', 'w')
filefire.write("0")
filefire.close()

fileWeapon = open('weapon.txt', 'w')
fileWeapon.write("0")
fileWeapon.close()

fileIntruder = open('intruder.txt', 'w')
fileIntruder.write("0")
fileIntruder.close()

result= firebase.put('/sass-cb9b6/sass/-MENTRivnr1SqB73rmqL','fire','0')
result= firebase.put('/sass-cb9b6/sass/-MENTRivnr1SqB73rmqL','intruder','0')
result= firebase.put('/sass-cb9b6/sass/-MENTRivnr1SqB73rmqL','weapon','0')
...
client = AgoraRTC.create_watcher("6297937a41ff430690344df869d6e273", "chromedriver.exe")
...
while True:
	...
	if result[0][0] == 1:
	 ...
	 #    f = open("weapon.txt", "w")
		f.write("1")
		f.close()
		result= firebase.put('/sass-cb9b6/sass/-MENTRivnr1SqB73rmqL','weapon','1')
		if sentt==0:
			sentt=1
			url = "https://www.fast2sms.com/dev/bulk"
			g = geocoder.ip('me')
	...
	for encoding in encodings:
		...
		if uncount>=7:
			...
			f.write("1")
			f.close()
			result= firebase.put('/sass-cb9b6/sass/-MENTRivnr1SqB73rmqL','intruder','1')
			if sentt==0:
				sentt=1
...
# Command to Run:
# python ObjectDetection.py --encodings encodings.pickle --output output/webcam_face_recognition_output.avi --display 1
